...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (phoneHeaderBtn) {
    phoneHeaderBtn.addEventListener('click', function() {
      var e=document.querySelectorAll('a[href^="tel:"]');var n=e.length>0?e[0].getAttribute("href").replace("tel:",""):"036566445";window.location.href="tel:"+n
    });
  }
        ...
        (async function() {
          try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: '393e75d3-2e3b-48ec-9c92-5dd0f61af351',
                name: name,
                email: email,
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "משרד עורכי דין משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '393e75d3-2e3b-48ec-9c92-5dd0f61af351';
